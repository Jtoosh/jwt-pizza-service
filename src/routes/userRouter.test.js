...
test('list users authorized', async () => {
    ...
    expect(listUsersRes2.body.users.length).toBeGreaterThanOrEqual(1);
    expect(listUsersRes2.body.users.length).toBeLessThanOrEqual(10);
    ...
    expect(listUsersRes2.body.users[0].name).toMatch(userMocks[8][0].name);

    expect(listUsersRes2.body.more).toBe(false);
